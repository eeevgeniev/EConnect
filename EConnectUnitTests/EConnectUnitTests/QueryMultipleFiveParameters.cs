...
{
    [TestClass]
    public class QueryMultipleFiveParameters
    {
        private const string CONNECTION_STRING = "connection";
        private const string QUERY = "query";

        [TestMethod]
        public void QueryMultipleFiveParametersReturnsTupleOfEmptyList()
        {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult, List<int> fourthResult, List<int> fifthResult) = connection.QueryMultiple<int, int, int, int, int>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFiveParametersReturnsTupleOfEmptyList()
        {
            MockDbConnection.ClearResults();
            MockDbConnection.AddResults(new List<List<Dictionary<string, object>>>()
            {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult, List<int> fourthResult, List<int> fifthResult) = connection.QueryMultipleAsync<int, int, int, int, int>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFiveParametersDictionaryReturnsValues()
        {
            ...
            (List<Dictionary<string, object>> firstResult,
                ...
                connection.QueryMultiple<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFiveParametersDictionaryReturnsValues()
        {
            string firstKey = "firstkey";
            string secondKey = "secondkey";
            ...
            (List<Dictionary<string, object>> firstResult,
                ...
                List<Dictionary<string, object>> fourthResult,
                List<Dictionary<string, object>> fifthResult) =
                connection.QueryMultipleAsync<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFiveParametersBoolAndBytesAndCharAndByteAndCharsReturnsValues()
        {
            bool boolValue = true;
            ...
            (List<bool> boolResults, List<byte[]> bytesResults, List<char> charResults, List<byte> byteResults, List<char[]> charsResults) = connection.QueryMultiple<bool, byte[], char, byte, char[]>(QUERY, null);
            ...
            Assert.AreEqual(byteResults.Count, 1);

            Assert.AreEqual(byteValue, byteResults[0]);

            Assert.AreEqual(charsResults.Count, 1);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFiveParametersBoolAndBytesAndCharAndByteAndCharsReturnsValues()
        {
            bool boolValue = true;
            byte[] byteValues = { 2, 4, 8, 16 };
            char charValue = 'e';
            ...
            (List<bool> boolResults, List<byte[]> bytesResults, List<char> charResults, List<byte> byteResults, List<char[]> charsResults) = connection.QueryMultipleAsync<bool, byte[], char, byte, char[]>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFiveParametersDateTimeAndDecimalAndDoubleAndIntAndLongReturnsValues()
        {
            ...
            (List<DateTime> dateTimeResults, List<decimal> decimalResults, List<double> doubleResults, List<int> intResults, List<long> longResults) = connection.QueryMultiple<DateTime, decimal, double, int, long>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFiveParametersDateTimeAndDecimalAndDoubleAndIntAndLongReturnsValues()
        {
            DateTime dateTimeValue = DateTime.Now;
            decimal decimalValue = 21.6M;
            double doubleValue = 33.6D;
            ...
            (List<DateTime> dateTimeResults, List<decimal> decimalResults, List<double> doubleResults, List<int> intResults, List<long> longResults) = connection.QueryMultipleAsync<DateTime, decimal, double, int, long>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFiveParametersSbyteAndShortAndStringAndUIntAndULongReturnsValues()
        {
            sbyte sByteValue = 33;
            short shortValue = 55;
            ...
            (List<sbyte> sbyteResults, List<short> shortResults, List<string> stringResults, List<uint> uintResults, List<ulong> ulongResults) = connection.QueryMultiple<sbyte, short, string, uint, ulong>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFiveParametersSbyteAndShortAndStringAndUIntAndULongReturnsValues()
        {
            sbyte sByteValue = 33;
            short shortValue = 55;
            string stringValue = "test";
            ...
            (List<sbyte> sbyteResults, List<short> shortResults, List<string> stringResults, List<uint> uintResults, List<ulong> ulongResults) = connection.QueryMultipleAsync<sbyte, short, string, uint, ulong>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFiveParametersStreamAnduShortAndIntAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            ...
            (List<Stream> streamResults, List<ushort> ushortResults, List<int> intResults, List<TestClassWithProperties> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<Stream, ushort, int, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFiveParametersStreamAnduShortAndIntAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            byte[] streamValues = { 1, 2, 3, 4 };
            ...
            (List<Stream> streamResults, List<ushort> ushortResults, List<int> intResults, List<TestClassWithProperties> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<Stream, ushort, int, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFiveParametersStreamAndUShortAndIntAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            byte[] streamValues = { 1, 2, 3, 4 };
            ...
            (List<Stream> streamResults, List<ushort> ushortResults, List<int> intResults, List<TestClassWithFields> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<Stream, ushort, int, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFiveParametersStreamAndUShortAndIntAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            byte[] streamValues = { 1, 2, 3, 4 };
            ...
            (List<Stream> streamResults, List<ushort> ushortResults, List<int> intResults, List<TestClassWithFields> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<Stream, ushort, int, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
