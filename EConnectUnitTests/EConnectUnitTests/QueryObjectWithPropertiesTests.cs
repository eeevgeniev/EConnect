...
{
    [TestClass]
    public class QueryObjectWithPropertiesTests
    {
        ...
        public void QueryReturnsEmptyListIfThereAreNoValues()
        {
            ...
            List<TestClassWithProperties> values = connection.Query<TestClassWithProperties>(QUERY, null);
        ...
        public void QueryAsyncReturnsEmptyListIfThereAreNoValues()
        {
            ...
            List<TestClassWithProperties> values = connection.QueryAsync<TestClassWithProperties>(QUERY, null).Result;
        ...
        public void QueryReturnsObjectWithNoDefaultConstructor()
        {
            ...
            List<TestClassWithPropertiesNoDefaultConstructor> values = connection.Query<TestClassWithPropertiesNoDefaultConstructor>(QUERY, null);
        ...
        public void QueryAsyncReturnsWithNoDefaultConstructor()
        {
            ...
            List<TestClassWithPropertiesNoDefaultConstructor> values = connection.QueryAsync<TestClassWithPropertiesNoDefaultConstructor>(QUERY, null).Result;
        ...
        public void QueryDoesNotSetPropertiesWhichHaveModifiersDifferentFromPublic()
        {
            ...
            List<TestClassWithPropertiesWhichMustNotBeSet> values = connection.Query<TestClassWithPropertiesWhichMustNotBeSet>(QUERY, null);
        ...
        public void QueryAsyncDoesNotSetPropertiesWhichHaveModifiersDifferentFromPublic()
        {
            ...
            List<TestClassWithPropertiesWhichMustNotBeSet> values = connection.QueryAsync<TestClassWithPropertiesWhichMustNotBeSet>(QUERY, null).Result;
