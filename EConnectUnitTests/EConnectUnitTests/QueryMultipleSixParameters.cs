...
{
    [TestClass]
    public class QueryMultipleSixParameters
    {
        private const string CONNECTION_STRING = "connection";
        private const string QUERY = "query";

        [TestMethod]
        public void QueryMultipleSixParametersReturnsTupleOfEmptyList()
        {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult, List<int> fourthResult, List<int> fifthResult, List<int> sixthResult) = connection.QueryMultiple<int, int, int, int, int, int>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncSixParametersReturnsTupleOfEmptyList()
        {
            MockDbConnection.ClearResults();
            MockDbConnection.AddResults(new List<List<Dictionary<string, object>>>()
            {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult, List<int> fourthResult, List<int> fifthResult, List<int> sixthResult) = connection.QueryMultipleAsync<int, int, int, int, int, int>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleSixParametersDictionaryReturnsValues()
        {
            ...
            (List<Dictionary<string, object>> firstResult,
                ...
                connection.QueryMultiple<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncSixParametersDictionaryReturnsValues()
        {
            string firstKey = "firstkey";
            string secondKey = "secondkey";
            ...
            (List<Dictionary<string, object>> firstResult,
                ...
                List<Dictionary<string, object>> fifthResult,
                List<Dictionary<string, object>> sixthResult) =
                connection.QueryMultipleAsync<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleSixParametersBoolAndBytesAndCharAndByteAndCharsAndDateTimeReturnsValues()
        {
            bool boolValue = true;
            ...
            (List<bool> boolResults, List<byte[]> bytesResults, List<char> charResults, List<byte> byteResults, List<char[]> charsResults, List<DateTime> dateTimeResults) = connection.QueryMultiple<bool, byte[], char, byte, char[], DateTime>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncSixParametersBoolAndBytesAndCharAndByteAndCharsAndDateTimeReturnsValues()
        {
            bool boolValue = true;
            byte[] byteValues = { 2, 4, 8, 16 };
            char charValue = 'e';
            ...
            (List<bool> boolResults, List<byte[]> bytesResults, List<char> charResults, List<byte> byteResults, List<char[]> charsResults, List<DateTime> dateTimeResults) = connection.QueryMultipleAsync<bool, byte[], char, byte, char[], DateTime>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleSixParametersDateTimeAndDecimalAndDoubleAndIntAndLongAndSByteAndShortReturnsValues()
        {
            ...
            (List<decimal> decimalResults, List<double> doubleResults, List<int> intResults, List<long> longResults, List<sbyte> sbyteResults, List<short> shortResults) = connection.QueryMultiple<decimal, double, int, long, sbyte, short>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncSixParametersDateTimeAndDecimalAndDoubleAndIntAndLongAndSByteAndShortReturnsValues()
        {
            decimal decimalValue = 21.6M;
            double doubleValue = 33.6D;
            int intValue = 133;
            ...
            (List<decimal> decimalResults, List<double> doubleResults, List<int> intResults, List<long> longResults, List<sbyte> sbyteResults, List<short> shortResults) = connection.QueryMultipleAsync<decimal, double, int, long, sbyte, short>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleSixParametersStringAndUIntAndULongAndLongAndSByteAndShortReturnsValues()
        {
            ...
            (List<string> stringResults, List<uint> uintResults, List<ulong> ulongResults, List<sbyte> sbyteResults, List<short> shortResults, List<long> longResults) = connection.QueryMultiple<string, uint, ulong, sbyte, short, long>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncSixParametersStringAndUIntAndULongAndLongAndSByteAndShortReturnsValues()
        {
            string stringValue = "test";
            uint uIntValue = 121;
            ulong uLongValue = 77;
            ...
            (List<string> stringResults, List<uint> uintResults, List<ulong> ulongResults, List<sbyte> sbyteResults, List<short> shortResults, List<long> longResults) = connection.QueryMultipleAsync<string, uint, ulong, sbyte, short, long>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleSixParametersStreamAnduShortAndIntAndLongAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            ...
            (List<Stream> streamResults, List<ushort> ushortResults, List<int> intResults, List<long> longResults, List<TestClassWithProperties> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<Stream, ushort, int, long, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncSixParametersStreamAnduShortAndIntAndLongAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            byte[] streamValues = { 1, 2, 3, 4 };
            ...
            (List<Stream> streamResults, List<ushort> ushortResults, List<int> intResults, List<long> longResults, List<TestClassWithProperties> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<Stream, ushort, int, long, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleSixParametersStreamAndUShortAndIntAndLongAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            byte[] streamValues = { 1, 2, 3, 4 };
            ...
            (List<Stream> streamResults, List<ushort> ushortResults, List<int> intResults, List<long> longResults, List<TestClassWithFields> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<Stream, ushort, int, long, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncSixParametersStreamAndUShortAndIntAndLongAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            byte[] streamValues = { 1, 2, 3, 4 };
            ...
            (List<Stream> streamResults, List<ushort> ushortResults, List<int> intResults, List<long> longResults, List<TestClassWithFields> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<Stream, ushort, int, long, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
