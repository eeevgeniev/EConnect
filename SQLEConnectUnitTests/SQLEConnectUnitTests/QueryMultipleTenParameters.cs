...
{
    [TestClass]
    public class QueryMultipleTenParameters
    {
        private const string CONNECTION_STRING = "connection";
        private const string QUERY = "query";

        [TestMethod]
        public void QueryMultipleTenParametersReturnsTupleOfEmptyList()
        {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult, List<int> fourthResult, List<int> fifthResult, List<int> sixthResult, List<int> seventhResult, List<int> eightResult, List<int> ninthResult, List<int> tenthResult) = connection.QueryMultiple<int, int, int, int, int, int, int, int, int, int>(QUERY, null);
            ...
            Assert.AreEqual(0, tenthResult.Count);
        }

        [TestMethod]
        public void QueryMultipleAsyncTenParametersReturnsTupleOfEmptyList()
        {
            MockDbConnection.ClearResults();
            MockDbConnection.AddResults(new List<List<Dictionary<string, object>>>()
            {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult, List<int> fourthResult, List<int> fifthResult, List<int> sixthResult, List<int> seventhResult, List<int> eightResult, List<int> ninthResult, List<int> tenthResult) = connection.QueryMultipleAsync<int, int, int, int, int, int, int, int, int, int>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleTenParametersDictionaryReturnsValues()
        {
            ...
            int intTenthValue = 9;
            string stringTenthValue = "tenth test";
            ...
            MockDbConnection.AddResults(new List<List<Dictionary<string, object>>>()
            {
                ...
                new List<Dictionary<string, object>>()
                {
                    new Dictionary<string, object>()
                    {
                        { firstKey, intTenthValue },
                        { secondKey, stringTenthValue }
                    }
                }
            });
            ...
            (List<Dictionary<string, object>> firstResult,
                ...
                List<Dictionary<string, object>> tenthResult) =
                connection.QueryMultiple<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null);
            ...
            Assert.AreEqual(1, tenthResult.Count);

            Assert.IsTrue(tenthResult[0].ContainsKey(firstKey));
            Assert.IsTrue(tenthResult[0].ContainsKey(secondKey));

            Assert.AreEqual(intTenthValue, tenthResult[0][firstKey]);
            Assert.AreEqual(stringTenthValue, tenthResult[0][secondKey]);
        }

        [TestMethod]
        public void QueryMultipleAsyncTenParametersDictionaryReturnsValues()
        {
            string firstKey = "firstkey";
            string secondKey = "secondkey";
            ...
            (List<Dictionary<string, object>> firstResult,
                ...
                List<Dictionary<string, object>> ninthResult,
                List<Dictionary<string, object>> tenthResult) =
                connection.QueryMultipleAsync<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleTenParametersBoolAndBytesAndCharAndByteAndCharsAndDateTimeAndDecimalAndDoubleAndIntAndLongReturnsValues()
        {
            bool boolValue = true;
            ...
            (List<bool> boolResults,
                ...
                List<int> intResults,
                List<long> longResults) = connection.QueryMultiple<bool, byte[], char, byte, char[], DateTime, decimal, double, int, long>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncTenParametersBoolAndBytesAndCharAndByteAndCharsAndDateTimeAndDecimalAndDoubleAndIntAndLongReturnsValues()
        {
            bool boolValue = true;
            byte[] byteValues = { 2, 4, 8, 16 };
            char charValue = 'e';
            ...
            (List<bool> boolResults,
                ...
                List<double> doubleResults,
                List<int> intResults,
                List<long> longResults) = connection.QueryMultipleAsync<bool, byte[], char, byte, char[], DateTime, decimal, double, int, long>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleTenParametersDateTimeAndDecimalAndDoubleAndIntAndLongAndSByteAndShortAndStringAndUIntAndULongAndUShortAndDecimalAndDoubleAndBoolReturnsValues()
        {
            long longValue = 535;
            sbyte sByteValue = 33;
            short shortValue = 55;
            ...
            (List<long> longResults,
                ...
                List<decimal> decimalResults,
                List<double> doubleResults,
                List<bool> boolResults) = connection.QueryMultiple<long, sbyte, short, string, uint, ulong, ushort, decimal, double, bool>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncTenParametersDateTimeAndDecimalAndDoubleAndIntAndLongAndSByteAndShortAndStringAndUIntAndULongAndUShortAndDecimalAndDoubleAndBoolReturnsValues()
        {
            long longValue = 535;
            sbyte sByteValue = 33;
            short shortValue = 55;
            ...
            (List<long> longResults,
                ...
                List<decimal> decimalResults,
                List<double> doubleResults,
                List<bool> boolResults) = connection.QueryMultipleAsync<long, sbyte, short, string, uint, ulong, ushort, decimal, double, bool>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleTenParametersStreamAndUShortAndIntAndUIntAndLongAndULongAndDecimalAndBoolAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            ...
            (List<Stream> streamResults,
                ...
                List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<Stream, ushort, int, uint, long, ulong, decimal, bool, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);

            Assert.AreEqual(streamResults.Count, 1);
        ...
        [TestMethod]
        public void QueryMultipleAsyncTenParametersStreamAndUShortAndIntAndUIntAndLongAndULongAndDecimalAndBoolAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            byte[] streamValues = { 1, 2, 3, 4 };
            ...
            (List<Stream> streamResults,
                ...
                List<bool> boolResults,
                List<TestClassWithProperties> results,
                List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<Stream, ushort, int, uint, long, ulong, decimal, bool, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
        ...
        public void QueryMultipleNineParametersStreamAndUShortAndIntAndUIntAndLongAndULongAndDecimalAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            ...
            (List<Stream> streamResults,
                ...
                List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<Stream, ushort, int, uint, long, ulong, decimal, bool, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);
        ...
        public void QueryMultipleAsyncNineParametersStreamAndUShortAndIntAndUIntAndLongAndULongAndDecimalAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            ...
            (List<Stream> streamResults,
                ...
                List<bool> boolResults,
                List<TestClassWithFields> results,
                List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<Stream, ushort, int, uint, long, ulong, decimal, bool, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
