...
[TestClass]
public class QuerySingleAsyncEntityTests
{
    private const string CONNECTION_STRING = "connection";
    private const string QUERY = "query";

    [TestMethod]
    public void QuerySingleAsyncGetsCorrectlyEntity()
    {
        const int firstId = 1;
        ...
        (bool hasResult, Person person) result = connection.QuerySingleAsync<Person>(
            null,
            QUERY,
            null,
            false,
    ...
    [TestMethod]
    public void QuerySingleAsyncGetsCorrectlyEntityWithMultipleKeys()
    {
        const int id = 1;
