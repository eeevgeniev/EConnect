...
{
    [TestClass]
    public class SingleObjectWithPropertiesTests
    {
        ...
        public void SingleReturnsClassReturnsDefaultIfThereAreNoValues()
        {
            ...
            (bool hasResult, TestClassWithProperties value) value = connection.Single<TestClassWithProperties>(QUERY, null);
        ...
        public void SingleAsyncReturnsClassReturnsDefaultIfThereAreNoValues()
        {
            ...
            (bool hasResult, TestClassWithProperties value) value = connection.SingleAsync<TestClassWithProperties>(QUERY, null).Result;
        ...
        MockDbConnection.ClearResults();
            ...
            Assert.AreEqual(bytes.Length, streamBytes.Length);

            for (int i = 0; i < bytes.Length; i++)
            {
                Assert.AreEqual(bytes[i], streamBytes[i]);
            }
        ...
        public void SingleReturnsObjectWithNoDefaultConstructor()
        {
            ...
            (bool hasResult, TestClassWithPropertiesNoDefaultConstructor value) value = connection.Single<TestClassWithPropertiesNoDefaultConstructor>(QUERY, null);
        ...
        public void SingleAsyncReturnsWithNoDefaultConstructor()
        {
            ...
            (bool hasResult, TestClassWithPropertiesNoDefaultConstructor value) value = connection.SingleAsync<TestClassWithPropertiesNoDefaultConstructor>(QUERY, null).Result;
        ...
        public void SingleDoesNotSetPropertiesWhichHaveModifiersDifferentFromPublic()
        {
            ...
            (bool hasResult, TestClassWithPropertiesWhichMustNotBeSet value) value = connection.Single<TestClassWithPropertiesWhichMustNotBeSet>(QUERY, null);
        ...
        public void SingleAsyncDoesNotSetPropertiesWhichHaveModifiersDifferentFromPublic()
        {
            ...
            (bool hasResult, TestClassWithPropertiesWhichMustNotBeSet value) value = connection.SingleAsync<TestClassWithPropertiesWhichMustNotBeSet>(QUERY, null).Result;
