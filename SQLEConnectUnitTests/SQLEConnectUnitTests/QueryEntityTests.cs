...
namespace SQLEConnectUnitTests
{
	...
	public class QueryEntityTests
	{
		...
		[TestMethod]
		public void QueryGetsCorrectlyEntities()
		{
			const int firstId = 1;
			...
			List<Person> persons = connection.Query<Person>(
				null, 
				QUERY, 
				null, 
				false, 
		...
		[TestMethod]
		public void QueryGetsCorrectlyEntitiesWithMultipleKeys()
		{
			const int id = 1;
		...
		[TestMethod]
		public void QueryGetsCorrectlyEntitiesWithMultipleKeysIfOneOfTheKeysIsNotCorrect()
		{
			const int id = 1;
			const string name = "Test1";
			const string secondName = "Test2";
		...
		[TestMethod]
		public void QueryGetsCorrectlyEntityWithChildEntity()
		{
			...
			List<Address> addresses = connection.Query<Address>(
		...
		[TestMethod]
		public void QueryGetsCorrectlyEntityWithChildCollectionEntity()
		{
			...
			List<City> cities = connection.Query<City>(
