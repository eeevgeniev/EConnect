...
{
    [TestClass]
    public class QueryMultipleThreeParametersTests
    {
        private const string CONNECTION_STRING = "connection";
        private const string QUERY = "query";

        [TestMethod]
        public void QueryMultipleThreeParametersReturnsTupleOfEmptyList()
        {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult) = connection.QueryMultiple<int, int, int>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersReturnsTupleOfEmptyList()
        {
            MockDbConnection.ClearResults();
            MockDbConnection.AddResults(new List<List<Dictionary<string, object>>>()
            {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult) = connection.QueryMultipleAsync<int, int, int>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleThreeParametersDictionaryReturnsValues()
        {
            ...
            (List<Dictionary<string, object>> firstResult, List<Dictionary<string, object>> secondResult, List<Dictionary<string, object>> thirdResult) = 
                connection.QueryMultiple<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersDictionaryReturnsValues()
        {
            string firstKey = "firstkey";
            string secondKey = "secondkey";
            ...
            (List<Dictionary<string, object>> firstResult, List<Dictionary<string, object>> secondResult, List<Dictionary<string, object>> thirdResult) =
                connection.QueryMultipleAsync<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleThreeParametersBoolAndBytesAndCharReturnsValues()
        {
            bool boolValue = true;
            ...
            (List<bool> boolResults, List<byte[]> byteResults, List<char> charResults) = connection.QueryMultiple<bool, byte[], char>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersBoolAndBytesAndCharReturnsValues()
        {
            bool boolValue = true;
            byte[] byteValues = { 2, 4, 8, 16 };
            char charValue = 'e';
            ...
            (List<bool> boolResults, List<byte[]> byteResults, List<char> charResults) = connection.QueryMultipleAsync<bool, byte[], char>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleThreeParametersByteAndCharsAndDateTimeReturnsValues()
        {
            byte byteValue = 21;
            ...
            (List<byte> byteResults, List<char[]> charsResults, List<DateTime>  dateTimeResults) = connection.QueryMultiple<byte, char[], DateTime>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersByteAndCharsAndDateTimeReturnsValues()
        {
            byte byteValue = 21;
            char[] charValues = { 'f', 'g', 'h' };
            DateTime dateTimeValue = DateTime.Now;
            ...
            (List<byte> byteResults, List<char[]> charsResults, List<DateTime> dateTimeResults) = connection.QueryMultipleAsync<byte, char[], DateTime>(QUERY, null).Result;
            ...
            Assert.AreEqual(dateTimeResults.Count, 1);

            Assert.AreEqual(dateTimeValue, dateTimeResults[0]);
        }

        [TestMethod]
        public void QueryMultipleThreeParametersCharsAndDateTimeReturnValues()
        {
            char[] charValues = { 'f', 'g', 'h' };
            DateTime dateTimeValue = DateTime.Now;
            ...
            (List<char[]> charsResults, List<DateTime> dateTimeResults, List<decimal> decimalResults) = connection.QueryMultiple<char[], DateTime, decimal>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersCharsAndDateTimeReturnValues()
        {
            char[] charValues = { 'f', 'g', 'h' };
            DateTime dateTimeValue = DateTime.Now;
            decimal decimalValue = 21.6M;
            ...
            (List<char[]> charsResults, List<DateTime> dateTimeResults, List<decimal> decimalResults) = connection.QueryMultipleAsync<char[], DateTime, decimal>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleThreeParametersDoubleAndFloarAndGuidReturnsValues()
        {
            ...
            (List<double> doubleResults, List<float> floatResults, List<Guid> guidResults) = connection.QueryMultiple<double, float, Guid>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersDoubleAndFloarAndGuidReturnsValues()
        {
            double doubleValue = 33.6D;
            float floatValue = 33.6F;
            Guid guidValue = Guid.NewGuid();
            ...
            (List<double> doubleResults, List<float> floatResults, List<Guid> guidResults) = connection.QueryMultipleAsync<double, float, Guid>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleThreeParametersIntAndLongAndSbyteReturnsValues()
        {
            int intValue = 33;
            long longValue = 55;
            sbyte sByteValue = 33;
            ...
            (List<int> intResults, List<long> longResults, List<sbyte> sbyteResults) = connection.QueryMultiple<int, long, sbyte>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersIntAndLongAndSbyteReturnsValues()
        {
            int intValue = 33;
            long longValue = 55;
            sbyte sByteValue = 33;
            ...
            (List<int> intResults, List<long> longResults, List<sbyte> sbyteResults) = connection.QueryMultipleAsync<int, long, sbyte>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleThreeParametersShortAndStreamAndStringReturnsValues()
        {
            ...
            (List<short> shortResults, List<Stream> streamResults, List<string> stringResults) = connection.QueryMultiple<short, Stream, string>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersShortAndStreamAndStringReturnsValues()
        {
            byte[] streamValues = { 1, 2, 3, 4 };
            ...
            (List<short> shortResults, List<Stream> streamResults, List<string> stringResults) = connection.QueryMultipleAsync<short, Stream, string>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleThreeParametersUintAndULongAndUshortReturnValues()
        {
            uint uIntValue = 33;
            ulong uLongValue = 55;
            ...
            (List<uint> uintResults, List<ulong> ulongResults, List<ushort> ushortResults) = connection.QueryMultiple<uint, ulong, ushort>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersUintAndULongAndUshortReturnValues()
        {
            uint uIntValue = 33;
            ulong uLongValue = 55;
            ushort uShortValue = 55;
            ...
            (List<uint> uintResults, List<ulong> ulongResults, List<ushort> ushortResults) = connection.QueryMultipleAsync<uint, ulong, ushort>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleThreeParametersIntAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            int intValue = 22;
            ...
            (List<int> intResults, List<TestClassWithProperties> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<int, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersIntAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            int intValue = 22;
            ...
            (List<int> intResults, List<TestClassWithProperties> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<int, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleThreeParametersIntAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            int intValue = 45;
            ...
            (List<int> intResults, List<TestClassWithFields> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<int, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncThreeParametersIntAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            int intValue = 45;
            ...
            (List<int> intResults, List<TestClassWithFields> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<int, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
