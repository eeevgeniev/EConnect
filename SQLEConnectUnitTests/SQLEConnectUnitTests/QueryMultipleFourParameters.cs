...
{
    [TestClass]
    public class QueryMultipleFourParameters
    {
        private const string CONNECTION_STRING = "connection";
        private const string QUERY = "query";

        [TestMethod]
        public void QueryMultipleFourParametersReturnsTupleOfEmptyList()
        {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult, List<int> fourthResult) = connection.QueryMultiple<int, int, int, int>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFourParametersReturnsTupleOfEmptyList()
        {
            MockDbConnection.ClearResults();
            MockDbConnection.AddResults(new List<List<Dictionary<string, object>>>()
            {
            ...
            (List<int> firstResult, List<int> secondResult, List<int> thirdResult, List<int> fourthResult) = connection.QueryMultipleAsync<int, int, int, int>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFourParametersDictionaryReturnsValues()
        {
            ...
            (List<Dictionary<string, object>> firstResult, 
                ...
                connection.QueryMultiple<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFourParametersDictionaryReturnsValues()
        {
            string firstKey = "firstkey";
            string secondKey = "secondkey";
            ...
            (List<Dictionary<string, object>> firstResult,
                ...
                List<Dictionary<string, object>> thirdResult,
                List<Dictionary<string, object>> fourthResult) =
                connection.QueryMultipleAsync<Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFourParametersBoolAndBytesAndCharAndByteReturnsValues()
        {
            bool boolValue = true;
            ...
            (List<bool> boolResults, List<byte[]> bytesResults, List<char> charResults, List<byte> byteResults) = connection.QueryMultiple<bool, byte[], char, byte>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFourParametersBoolAndBytesAndCharAndByteReturnsValues()
        {
            bool boolValue = true;
            byte[] byteValues = { 2, 4, 8, 16 };
            char charValue = 'e';
            ...
            (List<bool> boolResults, List<byte[]> bytesResults, List<char> charResults, List<byte> byteResults) = connection.QueryMultipleAsync<bool, byte[], char, byte>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFourParametersByteAndCharsAndDateTimeAndDecimalAndDoubleReturnsValues()
        {
            ...
            (List<char[]> charsResults, List<DateTime> dateTimeResults, List<decimal> decimalResults, List<double> doubleResults) = connection.QueryMultiple<char[], DateTime, decimal, double>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFourParametersByteAndCharsAndDateTimeAndDecimalAndDoubleReturnsValues()
        {
            char[] charValues = { 'f', 'g', 'h' };
            DateTime dateTimeValue = DateTime.Now;
            decimal decimalValue = 21.6M;
            ...
            (List<char[]> charsResults, List<DateTime> dateTimeResults, List<decimal> decimalResults, List<double> doubleResults) = connection.QueryMultipleAsync<char[], DateTime, decimal, double>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFourParametersIntAndLongAndSbyteAndShortReturnsValues()
        {
            int intValue = 33;
            long longValue = 55;
            sbyte sByteValue = 33;
            ...
            (List<int> intResults, List<long> longResults, List<sbyte> sbyteResults, List<short> shortResults) = connection.QueryMultiple<int, long, sbyte, short>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFourParametersIntAndLongAndSbyteAndShortReturnsValues()
        {
            int intValue = 33;
            long longValue = 55;
            sbyte sByteValue = 33;
            ...
            (List<int> intResults, List<long> longResults, List<sbyte> sbyteResults, List<short> shortResults) = connection.QueryMultipleAsync<int, long, sbyte, short>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFourParametersShortAndStreamAndStringAndUIntAndULongReturnsValues()
        {
            ...
            (List<Stream> streamResults, List<string> stringResults, List<uint> uintResults, List<ulong> ulongResults) = connection.QueryMultiple<Stream, string, uint, ulong>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFourParametersShortAndStreamAndStringAndUIntAndULongReturnsValues()
        {
            byte[] streamValues = { 1, 2, 3, 4 };
            ...
            (List<Stream> streamResults, List<string> stringResults, List<uint> uintResults, List<ulong> ulongResults) = connection.QueryMultipleAsync<Stream, string, uint, ulong>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFourParametersuShortAndIntAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            ...
            (List<ushort> ushortResults, List<int> intResults, List<TestClassWithProperties> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<ushort, int, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFourParametersUShortAndIntAndObjectWithNoConstructorAndObjectWithConstructorReturnValues()
        {
            ushort uShortValue = 55;
            int intValue = 22;
            ...
            (List<ushort> ushortResults, List<int> intResults, List<TestClassWithProperties> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<ushort, int, TestClassWithProperties, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
        ...
        [TestMethod]
        public void QueryMultipleFourParametersUShortAndIntAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            ushort uShortValue = 55;
            int intValue = 45;
            ...
            (List<ushort> ushortResults, List<int> intResults, List<TestClassWithFields> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultiple<ushort, int, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null);
        ...
        [TestMethod]
        public void QueryMultipleAsyncFourParametersUShortAndIntAndObjectWithFieldsAndNoConstructorAndObjectWithFieldsAndConstructorReturnsValues()
        {
            ushort uShortValue = 55;
            int intValue = 45;
            ...
            (List<ushort> ushortResults, List<int> intResults, List<TestClassWithFields> results, List<TestClassWithFieldsNoDefaultConstructor> resultsNoConstructor) = connection.QueryMultipleAsync<ushort, int, TestClassWithFields, TestClassWithFieldsNoDefaultConstructor>(QUERY, null).Result;
