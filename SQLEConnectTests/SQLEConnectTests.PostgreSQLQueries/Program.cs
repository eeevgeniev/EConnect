...
namespace SQLEConnectTests.PostgreSQLQueries
{
    internal class Program
    {
        ...
        private static void GetDateTime(string connectionString)
        {
            ...
            Debug.Assert(dateTimeResults[1].ToLocalTime() == Constants.DateTimeValue2);
        }
        ...
        private static void GetNullableDateTime(string connectionString)
        {
            ...
            Debug.Assert(nullableDateTimeResults[1]?.ToLocalTime() == Constants.NullableDateTimeValue2);
        }
        ...
        private static void GetSingleDateTime(string connectionString)
        {
            ...
            Debug.Assert(dateTimeResult.ToLocalTime() == Constants.DateTimeValue2);
        }
        ...
        private static void GetSingleNullableDateTime(string connectionString)
        {
            ...
            Debug.Assert(nullableDateTimeResult?.ToLocalTime() == Constants.NullableDateTimeValue2);
        }
            ...
            for (int i = 0; i < results.Count; i++)
            {
                ...
                else if (i == 1)
                {
                    foreach (string key in keys.Keys)
                    {
                        if (string.Equals(key, nameof(GenericTable.ByteNumber), StringComparison.OrdinalIgnoreCase))
                        {
                            Debug.Assert((short)keys[key] == Constants.ByteNumber2);
                        }
                        else if (string.Equals(key, nameof(GenericTable.NullableByteNumber), StringComparison.OrdinalIgnoreCase))
                        {
                            Debug.Assert((short?)keys[key] == Constants.NullableByteNumber2);
                        }
                        else if (string.Equals(key, nameof(GenericTable.BoolValue), StringComparison.OrdinalIgnoreCase))
                        {
                        ...
                        {
                            Debug.Assert(((DateTime)keys[key]).ToLocalTime() == Constants.DateTimeValue2);
                        }
                        else if (string.Equals(key, nameof(GenericTable.NullableDateTimeValue), StringComparison.OrdinalIgnoreCase))
                        {
                            Debug.Assert(((DateTime?)keys[key])?.ToLocalTime() == Constants.NullableDateTimeValue2);
                        }
                        else if (string.Equals(key, nameof(GenericTable.DecimalNumber), StringComparison.OrdinalIgnoreCase))
                        {
                        ...
                        {
                            Debug.Assert((short)keys[key] == Constants.SByteNumber2);
                        }
                        else if (string.Equals(key, nameof(GenericTable.NullableSByteNumber), StringComparison.OrdinalIgnoreCase))
                        {
                            Debug.Assert((short?)keys[key] == Constants.NullableSByteNumber2);
                        }
                        else if (string.Equals(key, nameof(GenericTable.ShortNumber), StringComparison.OrdinalIgnoreCase))
                        {
        ...
        private static void CheckSingleDict(Dictionary<string, object> dict)
        {
            foreach (string key in dict.Keys)
            {
                if (string.Equals(key, nameof(GenericTable.ByteNumber), StringComparison.OrdinalIgnoreCase))
                {
                    Debug.Assert((short)dict[key] == Constants.ByteNumber2);
                }
                else if (string.Equals(key, nameof(GenericTable.NullableByteNumber), StringComparison.OrdinalIgnoreCase))
                {
                    Debug.Assert((short?)dict[key] == Constants.NullableByteNumber2);
                }
                else if (string.Equals(key, nameof(GenericTable.BoolValue), StringComparison.OrdinalIgnoreCase))
                {
                ...
                {
                    Debug.Assert(((DateTime)dict[key]).ToLocalTime() == Constants.DateTimeValue2);
                }
                else if (string.Equals(key, nameof(GenericTable.NullableDateTimeValue), StringComparison.OrdinalIgnoreCase))
                {
                    Debug.Assert(((DateTime?)dict[key])?.ToLocalTime() == Constants.NullableDateTimeValue2);
                }
                else if (string.Equals(key, nameof(GenericTable.DecimalNumber), StringComparison.OrdinalIgnoreCase))
                {
                ...
                {
                    Debug.Assert((short)dict[key] == Constants.SByteNumber2);
                }
                else if (string.Equals(key, nameof(GenericTable.NullableSByteNumber), StringComparison.OrdinalIgnoreCase))
                {
                    Debug.Assert((short?)dict[key] == Constants.NullableSByteNumber2);
                }
                else if (string.Equals(key, nameof(GenericTable.ShortNumber), StringComparison.OrdinalIgnoreCase))
                {
