...
namespace SQLEConnect.Parsers
{
    ...
    internal class NullableDecimalParser : BaseParser, IParser<decimal?>
    {
        ...
        /// <returns>IEnumerable where the result is Nullable Decimal.</returns>
        ...
        /// <summary>
        /// Returns only one result from the DbDataReader, the Nullable Decimal value must be contained in the first field column (index 0) in the DbDataReader.
        ...
        public Type Type() => BaseTypeHelper.NullableDecimalType;
    }
}