...
namespace SQLEConnect.Parsers
{
    ...
    internal sealed class NullableByteParser : BaseParser, IParser<byte?>
    {
        ...
        /// <returns>IEnumerable where the result is Nullable Byte.</returns>
        ...
        /// <summary>
        /// Returns only one result from the DbDataReader, the Nullable Byte value must be contained in the first field column (index 0) in the DbDataReader.
        ...
        public Type Type() => BaseTypeHelper.NullableByteType;
    }
}