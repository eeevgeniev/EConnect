...
namespace SQLEConnect.Parsers
{
    ...
    internal class NullableIntParser : BaseParser, IParser<int?>
    {
        ...
        /// <returns>IEnumerable where the result is Nullable Integer.</returns>
        ...
        /// <summary>
        /// Returns only one result from the DbDataReader, the Nullable Integer value must be contained in the first field column (index 0) in the DbDataReader.
        ...
        public Type Type() => BaseTypeHelper.NullableIntegerType;
    }
}